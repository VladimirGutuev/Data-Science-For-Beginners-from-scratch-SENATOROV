...
#
# feat - от слова feature, или же "фича", используется про добавлении нового функционала в проект.
# fix - используется при исправлениях багов.
# docs - используется при изменениях, связанных с документацией. Например, описание классов, описание модуля, или же файл Readme и т.д.
# style - при форматировании кода, изменении стиля, оформления кода.
# refactor - изменения в коде, не являющиеся фиксом багов, добавлением фичи, обычно упрощение кода.
# test - добавление или изменения тестов для проекта.
# build - изменения, связанные с зависимостями проекта, а также системами сборки проекта.
# ci - continuous integration, изменения, связанные с проверкой кода, например, работа над файлом линтеров или связанные с GitHub Actions.
# perf - изменения, связанные с эффективностью кода, например, увеличение скорости.
# chore - остальные изменения, вспомогательные задачи, не затрагивающие функциональность.
#
