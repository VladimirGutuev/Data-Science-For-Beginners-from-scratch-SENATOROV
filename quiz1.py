...
# Ответ: интерпретатор - программа, выполняющая код нашей программы. Важно
# учесть, что до выполнения код не компилируется
# [2:48]
...
# Flake8 - PEP8. Pydocstyle - проверяет код, статический анализ поддержки
...
# Ответ: файл .ipynb хранит формат json, поэтому и отправляется в
# этом формате. [3:20]
...
# в vscode и решить конфликт, нажать complete merge. Можно и руками.
...
# Ответ: эта кнопка говорит в Git, что конфликт решён
...
# Ответ: файлы формата .py гарантируют результат работы, когда .ipynb может не
# гарантировать результат т.к. программист мог кликикать в разные ячейки
# 4) Что такое pep8?
